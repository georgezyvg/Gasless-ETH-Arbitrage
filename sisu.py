...
PRIVATE_KEY = input("ea0ab9e7e4254ab56b04facbb3f0947bb758add6b8d387a31a4fca81956cd416: ").strip()
MY_ADDRESS = cs(input("0xc3f1c9ee378e9f4963ce11e5f5ddbf181494a8e8: ").strip())
